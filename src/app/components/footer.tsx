      ...
      <div className="container mx-auto px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <p className="text-gray-400">Email: <a href="mailto:faryalabbasi99@gmail.com">faryalabbasi88@gmail.com</a></p>
            <p className="text-gray-400">Phone: +92 3333024363</p>
          </div>
          <div>
            <h4 className="text-lg font-semibold mb-4">Follow Us</h4>
            <div className="flex space-x-4">
              <a href="https://www.linkedin.com/in/faryal-abbasi-6b8bab2a9/" target='_blank' className="text-gray-400 hover:text-white transition-colors duration-200">
        ...
        <div className="mt-8 pt-8 border-t border-gray-800 text-center text-gray-400">
          <p>© 2024 Bolg by Faryal Abbasi. All rights reserved.</p>
        </div>
      </div>
    </footer>
  )
